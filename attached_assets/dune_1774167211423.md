...
### Wallet PnL (simplified)
```sql
-- Requires: buys, sells, current holdings × current price
-- This is complex — consider using community queries as a starting point
-- Search dune.com for "wallet pnl" or "trader performance"
```
