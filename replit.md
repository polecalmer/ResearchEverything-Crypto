...
- MPP paywalls (user→owner): enrichment $0.50 flat, deep research $1.50, token analysis $1.50, token snapshot $0.15, next steps $0.10, dune query $0.05
- MPP deposits (server→Anthropic/Allium maxDeposit): enrichment $0.25 (VC) / $0.50 (liquid token), token analysis $1.50, deep research $1.50
